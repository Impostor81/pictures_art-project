...
/* harmony import */ var _modules_dragDrop__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/dragDrop */ "./src/js/modules/dragDrop.js");
/* harmony import */ var _modules_filterTab__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/filterTab */ "./src/js/modules/filterTab.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_showMore__WEBPACK_IMPORTED_MODULE_8__["default"])('.button-styles', '.styles-2'); // showMore('.button-styles', '#styles .row'); // вариант 2

  Object(_modules_calc__WEBPACK_IMPORTED_MODULE_2__["default"])('#size', '#material', '#options', '.promocode', '.calc-price');
  Object(_modules_filterTab__WEBPACK_IMPORTED_MODULE_4__["default"])();
  Object(_modules_pictureSize__WEBPACK_IMPORTED_MODULE_7__["default"])();
  ...
  Object(_modules_dragDrop__WEBPACK_IMPORTED_MODULE_3__["default"])();
});
...
var accordeon = function accordeon(triggersSelector) {
  var btns = document.querySelectorAll(triggersSelector); // добавил для того, если нужно чтобы при открывании одного все остальные закрывались, если нужно чтобы все отркрываться могли одновременно, то нужно убрать эти 6 строчек ниже
  ...
  btns.forEach(function (btn) {
    btn.addEventListener('click', function (e) {
      ...
      e.currentTarget.classList.toggle('active-style'); // можно также через this обратится: this.classList..., в данном случае e.curremtTarget = this
...
/* harmony default export */ __webpack_exports__["default"] = (accordeon); // в стилях добавим стили, убрав предыдущие, в том числе display:
// .often-questions .accordion-block {
...
var burger = function burger(menuSelector, burgerSelector) {
  ...
  menuElem.style.display = 'none'; // проверяем если меню скрыто и ширина экрана 992 и меньше, то показываем его
...
var filterTab = function filterTab() {
  ...
  items.forEach(function (item) {
    item.addEventListener('click', function (e) {
      var allPhotos = wrapper.querySelectorAll(".".concat(e.target.classList[0]));
...
/* harmony default export */ __webpack_exports__["default"] = (filterTab); //2 вариант не самый оптимальный, много повторяющихся обработчиков событий добавляем и много переменных инициализируем:
// const filterTab = () => {
...
var forms = function forms() {
  ...
  var clearInputs = function clearInputs() {
    ...
    allTextAreas.forEach(function (item) {
      return item.value = '';
    });
  ...
  function bindModal(triggerSelector, modalSelector, closeSelector) {
    ...
    trigger.forEach(function (el) {
      el.addEventListener('click', function (e) {
        ...
        btnPressed = true; // убираем тригер (кнопку) после нажатия (если это необходимо)
...
var pictureSize = function pictureSize() {
  var allSizesBlocks = document.querySelectorAll('.sizes-block');
  allSizesBlocks.forEach(function (item) {
    var allP = item.querySelectorAll('p');
    item.addEventListener('mouseenter', function () {
      var img = item.firstElementChild;
      allP.forEach(function (el, index) {
        return index !== 3 ? el.style.display = 'none' : 0;
      });
...
/* harmony default export */ __webpack_exports__["default"] = (showMore); // 2 вариант: когда карточек нет в верстке, но у нас есть объект в json файле, к которому обращаемся и оттуда подгружаем карточки, и убираем также саму кнопку
...
var sliders = function sliders(slides, direction, prev, next) {
  ...
  activateAnimation(); // при наведении на слайд отключается авматическая смена слайдов, а когда убрали курсов снова запускается автоматическая прокрутка слайдов
